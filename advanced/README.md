...
- [`src/generated/graphcool.graphql`](src/generated/graphcool.graphql) defines the **database schema**. It contains the GraphQL API exposed by the Graphcool Database. This file is automatically generated every time `graphcool deploy` is executed, according to the datamodel in `database/datamodel.graphql`.
